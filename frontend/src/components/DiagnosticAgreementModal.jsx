...
export const AUDITED_20_SITES_ETHIOPIA = [
  { site_name: "Gambella",       lat: 8.25,  lon: 34.58, county: "Gambella",          regime_id: 1, regime_name: "Western Unimodal",             pann: 1189, c1: 3.39, c2: 0.11, rh: 0.03, dunning_type: "Annual (rH < 1.0)", agreement: true, desc: "R1: Western Unimodal (rH=0.03)" },
  { site_name: "Assosa",         lat: 10.07, lon: 34.53, county: "Benishangul-Gumuz", regime_id: 1, regime_name: "Western Unimodal",             pann: 1192, c1: 4.21, c2: 0.60, rh: 0.14, dunning_type: "Annual (rH < 1.0)", agreement: true, desc: "R1: Western Unimodal (rH=0.14)" },
  { site_name: "Jimma",          lat: 7.67,  lon: 36.83, county: "Oromia",            regime_id: 1, regime_name: "Western Unimodal",             pann: 1493, c1: 3.62, c2: 0.37, rh: 0.10, dunning_type: "Annual (rH < 1.0)", agreement: true, desc: "R1: Western Unimodal (rH=0.10)" },
  { site_name: "Bahir Dar",      lat: 11.60, lon: 37.38, county: "Amhara",            regime_id: 1, regime_name: "Western Unimodal",             pann: 1433, c1: 5.57, c2: 2.46, rh: 0.44, dunning_type: "Annual (rH < 1.0)", agreement: true, desc: "R1: Western Unimodal (rH=0.44)" },
  { site_name: "Gondar",         lat: 12.60, lon: 37.47, county: "Amhara",            regime_id: 1, regime_name: "Western Unimodal",             pann: 1150, c1: 4.57, c2: 1.77, rh: 0.39, dunning_type: "Annual (rH < 1.0)", agreement: true, desc: "R1: Western Unimodal (rH=0.39)" },
  { site_name: "Bedele",         lat: 8.45,  lon: 36.35, county: "Oromia",            regime_id: 1, regime_name: "Western Unimodal",             pann: 1814, c1: 5.13, c2: 0.35, rh: 0.07, dunning_type: "Annual (rH < 1.0)", agreement: true, desc: "R1: Western Unimodal (rH=0.07)" },
  { site_name: "Addis Ababa",    lat: 9.03,  lon: 38.74, county: "Addis Ababa",       regime_id: 2, regime_name: "Bimodal Type 1 (Belg+Kiremt)", pann: 1181, c1: 4.07, c2: 2.25, rh: 0.55, dunning_type: "Annual (rH < 1.0)", agreement: true, desc: "R2: Bimodal Type 1 (rH=0.55)" },
  { site_name: "Kombolcha",      lat: 11.08, lon: 39.73, county: "Amhara",            regime_id: 2, regime_name: "Bimodal Type 1 (Belg+Kiremt)", pann: 1040, c1: 3.38, c2: 2.50, rh: 0.74, dunning_type: "Annual (rH < 1.0)", agreement: true, desc: "R2: Bimodal Type 1 (rH=0.74)" },
  { site_name: "Mekelle",        lat: 13.50, lon: 39.47, county: "Tigray",            regime_id: 2, regime_name: "Bimodal Type 1 (Belg+Kiremt)", pann: 654,  c1: 2.91, c2: 2.01, rh: 0.69, dunning_type: "Annual (rH < 1.0)", agreement: true, desc: "R2: Bimodal Type 1 (rH=0.69)" },
  { site_name: "Dire Dawa",      lat: 9.60,  lon: 41.87, county: "Dire Dawa",         regime_id: 2, regime_name: "Bimodal Type 1 (Belg+Kiremt)", pann: 626,  c1: 1.21, c2: 1.01, rh: 0.84, dunning_type: "Annual (rH < 1.0)", agreement: true, desc: "R2: Bimodal Type 1 (rH=0.84)" },
  { site_name: "Jijiga",         lat: 9.35,  lon: 42.80, county: "Somali",            regime_id: 2, regime_name: "Bimodal Type 1 (Belg+Kiremt)", pann: 545,  c1: 1.21, c2: 0.77, rh: 0.64, dunning_type: "Annual (rH < 1.0)", agreement: true, desc: "R2: Bimodal Type 1 (rH=0.64)" },
  { site_name: "Hawassa",        lat: 7.05,  lon: 38.48, county: "Sidama",            regime_id: 2, regime_name: "Bimodal Type 1 (Belg+Kiremt)", pann: 1000, c1: 1.84, c2: 0.76, rh: 0.41, dunning_type: "Annual (rH < 1.0)", agreement: true, desc: "R2: Bimodal Type 1 (rH=0.41)" },
  { site_name: "Arba Minch",     lat: 6.03,  lon: 37.55, county: "Gamo / SNNPR",      regime_id: 3, regime_name: "Bimodal Type 2 (Gu+Deyr)",     pann: 1032, c1: 0.93, c2: 1.54, rh: 1.65, dunning_type: "Biannual (rH > 1.0)", agreement: true, desc: "R3: Bimodal Type 2 (rH=1.65)" },
  { site_name: "Goba / Bale",    lat: 7.00,  lon: 39.98, county: "Oromia / Bale",     regime_id: 3, regime_name: "Bimodal Type 2 (Gu+Deyr)",     pann: 1127, c1: 1.07, c2: 1.88, rh: 1.76, dunning_type: "Biannual (rH > 1.0)", agreement: true, desc: "R3: Bimodal Type 2 (rH=1.76)" },
  { site_name: "Negelle Borana", lat: 5.33,  lon: 39.58, county: "Oromia / Borana",   regime_id: 3, regime_name: "Bimodal Type 2 (Gu+Deyr)",     pann: 636,  c1: 0.81, c2: 2.39, rh: 2.94, dunning_type: "Biannual (rH > 1.0)", agreement: true, desc: "R3: Bimodal Type 2 (rH=2.94)" },
  { site_name: "Yabello",        lat: 4.88,  lon: 38.09, county: "Oromia / Borana",   regime_id: 3, regime_name: "Bimodal Type 2 (Gu+Deyr)",     pann: 644,  c1: 0.88, c2: 2.03, rh: 2.31, dunning_type: "Biannual (rH > 1.0)", agreement: true, desc: "R3: Bimodal Type 2 (rH=2.31)" },
  { site_name: "Moyale",         lat: 3.53,  lon: 39.05, county: "Borana / Somali",   regime_id: 3, regime_name: "Bimodal Type 2 (Gu+Deyr)",     pann: 523,  c1: 0.70, c2: 2.16, rh: 3.08, dunning_type: "Biannual (rH > 1.0)", agreement: true, desc: "R3: Bimodal Type 2 (rH=3.08)" },
  { site_name: "Kebri Dehar",    lat: 6.73,  lon: 44.28, county: "Somali / Korahe",   regime_id: 3, regime_name: "Bimodal Type 2 (Gu+Deyr)",     pann: 428,  c1: 0.06, c2: 1.99, rh: 35.76, dunning_type: "Biannual (rH > 1.0)", agreement: true, desc: "R3: Bimodal Type 2 (rH=35.76)" },
  { site_name: "Gode",           lat: 5.95,  lon: 43.58, county: "Somali / Shabelle", regime_id: 3, regime_name: "Bimodal Type 2 (Gu+Deyr)",     pann: 271,  c1: 0.06, c2: 1.33, rh: 23.04, dunning_type: "Biannual (rH > 1.0)", agreement: true, desc: "R3: Bimodal Type 2 (rH=23.04)" },
  { site_name: "Semera",         lat: 11.79, lon: 41.00, county: "Afar",              regime_id: 0, regime_name: "Arid / Marginal",              pann: 263,  c1: 0.57, c2: 0.55, rh: 0.97, dunning_type: "Excluded (Low Rain)", agreement: true, desc: "R0: Arid / Marginal (rH=0.97)" },
]
